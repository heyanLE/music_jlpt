...
def main() -> None:
    ...
    parser.add_argument("--prelude-mode", choices=("first-line", "hidden"), help="New project default: first-line; independent of lyric-gap mode")
    ...
    learning_aids = configure_options(existing, args.neighbors or args.learning_assist, args.countdown or args.learning_assist, args.prelude_mode)
    ...
    if args.preset == "custom":
        ...
        handoff = duration_ms(background) if args.transition_ms == "auto" else int(args.transition_ms)
    ...
    write(project / "scene-timeline.json", {"schemaVersion": 2, "clock": "output", "preset": args.preset, "segments": segments})
