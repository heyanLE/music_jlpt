...
LOANWORDS = {"ラブ": "love", "チャンス": "chance", "ドキドキ": "doki-doki", "リアル": "real", "ムリ": "impossible", "キス": "kiss", "ハート": "heart", "ダンス": "dance", "パーティー": "party", "ロマン": "roman", "ドラマ": "drama", "スイート": "sweet", "ビター": "bitter"}
...
def main():
    ...
    review = ["# 迷っちゃうわ｜词卡审核稿", "", "所有拆词、词性、含义与非 QMTS 翻译均为自动草稿；请按帧号直接修改或指出需要替换的词卡。助词卡展示功能，不展示字典义。", ""]
    for frame in frames:
        cap = frame["caption"]
