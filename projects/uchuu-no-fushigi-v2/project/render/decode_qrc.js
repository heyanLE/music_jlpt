...
const report = {
  ...
  sourceHashes: Object.fromEntries(["lyrics.qm.qrc", "lyrics.qmRoma.qrc", "lyrics.qmts.qrc"].map(file => [file, sha256(path.join(SOURCE, file))])),
  outputs: {
    qm: decodeKara("lyrics.qm.qrc", "qm.json"),
    roma: decodeKara("lyrics.qmRoma.qrc", "roma.json"),
    translation: decodeLrc("lyrics.qmts.qrc", "translation.json")
  },
